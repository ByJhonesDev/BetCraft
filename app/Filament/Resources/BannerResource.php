...
class BannerResource extends Resource
{
    ...
    /**
     * @dev 𝓗𝓐𝓡𝓚𝓩𝓘𝓜 / by betcraft.com < - Esse sistema PRO - Entre no nosso Grupo  https://t.me/+dFr8-1AmUz5hZDc5
     * @return bool
     */
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('BET CRAFT CRIOU ESSA PLATAFORMA PARA VOCÊ')
                    ...
                    <div style="font-weight: 600; display: flex; align-items: center;">
                        ...
                        <a class="dark:text-white" 
                           style="
                                ...
                                margin-left: 10px;
                           " 
                           href="https://chat.whatsapp.com/CbVcYl2Iqcv1ne5wZ9dM49" 
                           target="_blank">
                            GRUPO TELEGRAM
                        </a>
                    </div>
